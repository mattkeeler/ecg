...
;; what variables specify), the help system can provide."))
   ...
   (lambda ()
     (when (< (emacs-version) 28)
       ...
       (format t "~%(unless package-archive-contents")
       (format t "  (package-refresh-contents))"))
    ...
    (cons
     ...
     (loop :for (theme version description) :in
           '(("adwaita" 24 "A colour scheme similar to the default theme of GNOME 3")
             ...
             ("modus-operandi" 28 "A flexible, accessible light theme")
             ("modus-vivendi" 28 "A flexible, accessible dark theme")
...
others need external packages.")
   ...
   (make-elpa-package "sly" "Additional Lisp support" 'nongnu-elpa)
